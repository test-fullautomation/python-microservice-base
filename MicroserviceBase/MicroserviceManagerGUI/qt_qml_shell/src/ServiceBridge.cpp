 ...
 * @brief Implementation of the ServiceBridge QML singleton.
 *
 * In WASM builds, calls window.callMicroservice() via EM_ASM and routes
 * the promise result/error back to Qt signals.
 */
                                 ...
                                 const QJsonArray &args)
{
    ...
    // in QtShellManager.js which calls _qtshell_onResponse/_qtshell_onError
