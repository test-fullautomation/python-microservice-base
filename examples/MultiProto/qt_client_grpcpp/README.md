# MultiProto Qt Client (Google grpc++ via vcpkg)

Qt Widgets UI client for **MultiProto** that links Google's
...
Output: `build\multi_proto_qt_gui.exe` linking against vcpkg DLLs in
